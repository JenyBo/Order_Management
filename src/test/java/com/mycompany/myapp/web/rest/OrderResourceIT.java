...
class OrderResourceIT {
    ...
    private static final LocalDate DEFAULT_EXPORT_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EXPORT_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getImportDate()).isEqualTo(DEFAULT_IMPORT_DATE);
        assertThat(testOrder.getExportDate()).isEqualTo(DEFAULT_EXPORT_DATE);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        assertThat(testOrder.getImportDate()).isEqualTo(UPDATED_IMPORT_DATE);
        assertThat(testOrder.getExportDate()).isEqualTo(UPDATED_EXPORT_DATE);
    }
